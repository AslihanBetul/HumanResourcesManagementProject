...
public class MailSenderService {
    ...
    @RabbitListener(queues = "queueEmployeeMailLeave")
    public void sendEmployeeLeaveMail(String mail) throws MessagingException {
        ...
        String htmlContent = "<html><body>" +
                ...
                "                    <td style=\"padding:0 30px 30px\">" +
                "                        <p style=\"font-family:Arial,sans-serif;color:#000000;font-size:19px;margin-top:14px;margin-bottom:0\">" +
                "                            Merhaba, tarafınıza izin tanımlammıştır. Hesabınızda giriş yaparak görüntüleyebilirsiniz. İyi izinler !" +
                "                        </p>" +
                ...
                "                    <td style=\"font-family:Arial,sans-serif;font-size:12px;color:#888888;padding-right:30px;padding-left:30px\"> +</td>" +
                "                </tr>" +
                "       <img style=\"width: 300px;margin: 0 auto ;\" src =https://i.pinimg.com/736x/6e/ae/4a/6eae4a13af8db638a5e6bc344364646a.jpg />" +
                "            </tbody></table>" +
                "        </td>" +
                "    </tr></tbody></table>" +
                "</body></html>";
        ...
        helper.setText(htmlContent, true);
        helper.setTo(mail);
        helper.setSubject("İzin Bilgilendirme");

        javaMailSender.send(mimeMessage);
    }
    @RabbitListener(queues = "queueApproveLeave")
    public void sendApproveLeaveMail(String mail) throws MessagingException {
        ...
        String htmlContent = "<html><body>" +
                ...
                "                    <td style=\"padding:0 30px 30px\">" +
                "                        <p style=\"font-family:Arial,sans-serif;color:#000000;font-size:19px;margin-top:14px;margin-bottom:0\">" +
                "                            Merhaba, izin talebiniz onaylanmıştır!" +
                "                        </p>" +
    ...
    @RabbitListener(queues = "queueDissapproveLeave")
    public void sendDissapproveLeaveMail(String mail) throws MessagingException {
        ...
        String htmlContent = "<html><body>" +
                ...
                "                    <td style=\"padding:0 30px 30px\">" +
                "                        <p style=\"font-family:Arial,sans-serif;color:#000000;font-size:19px;margin-top:14px;margin-bottom:0\">" +
                "                            Merhaba, izin talebiniz reddedilmiştir!" +
                "                        </p>" +
